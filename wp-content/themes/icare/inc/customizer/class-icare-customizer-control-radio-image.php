...
class iCare_Custom_sortable_Control extends WP_Customize_Control
{
    ...
    public function enqueue()
    {
        ...
        wp_enqueue_style('icare-customizer-repeater-admin-stylesheet', get_template_directory_uri() . '/assets/customizer_js_css/css/icare-admin-style.css', time());

        wp_enqueue_script('icare-customizer-repeater-script', get_template_directory_uri() . '/assets/customizer_js_css/js/icare-customizer_repeater.js', array('jquery', 'jquery-ui-draggable'), time(), true);
    ...
    public function render_content()
    {
		...
		<div class="icare-customizer-repeater-general-control-repeater customizer-repeater-general-control-droppable">
			<?php 
			if(!empty($values)){ 
				foreach ($values as $value) {?>
					<div class="icare-customizer-repeater-general-control-repeater-container customizer-repeater-draggable ui-sortable-handle">
			...
			foreach ($this->choices as $value => $label): ?>
        		...
        		if (!empty($value)) {?>
					<input type="hidden"
					       ...
					       class="icare-customizer-repeater-colector"
