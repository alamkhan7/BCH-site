...
<a class="skip-link screen-reader-text" href="#content"><?php esc_html_e( 'Skip to content', 'icare' ); ?></a>
  <!-- Header -->
  <header id="header" class="header"><?php if(get_theme_mod('icare_show_topbar')) { ?>
    ...
    <div class="header-main">
      <div class="header-main-wrapper <?php echo get_theme_mod('icare_fixed_header') ? 'navbar-scrolltofixed' : ''; ?> header_nav">
